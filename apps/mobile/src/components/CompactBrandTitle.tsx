...
export function CompactBrandTitle(
  ...
  return (
    <View
      aria-level={1}
      accessibilityLabel="ThroughLine, Threads"
      accessible
      role="heading"
      className="flex-row items-center gap-1.5"
      style={{ marginLeft: titleOffset }}
    >
      {/* ThroughLine: use the same product mark as the installed phone icon. */}
      <Image
        source={require("../../assets/throughline-icon.png")}
        style={{ width: 26, height: 26 }}
      />
      <Text
        allowFontScaling={props.allowFontScaling}
        className="font-t3-medium text-[18px] tracking-[-0.5px] text-foreground-muted"
      >
        ThroughLine
      </Text>
