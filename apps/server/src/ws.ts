        ...
        Effect.gen(function* () {
          ...
          const bootstrapProgram = Effect.gen(function* () {
            if (bootstrap?.createThread) {
              // ThroughLine: a bootstrap that races an existing thread row must not create twice;
              // the durable worker may have materialized it already.
        ...
        const dispatchEffect =
          normalizedCommand.type === "thread.turn.start"
            ? normalizedCommand.bootstrap
              ...
              : // ThroughLine: non-bootstrap turns ride the durable absurd rail.
            ...
            Effect.gen(function* () {
              ...
              if (symphonyApp === undefined) {
                return yield* new SymphonyRuntimeUnavailableError({
                  message: "Symphony queue worker is unavailable; symphony spawn failed closed.",
                });
              }
