...
const makeProviderService = Effect.fn("makeProviderService")(function* (
  ...
  const prepareMcpSession = (threadId: ThreadId, providerInstanceId: ProviderInstanceId) =>
    Effect.gen(function* () {
      // ThroughLine: upstream's per-thread access capabilities, plus the fork-owned ComsNet
      // capability. This call site is the policy boundary: the registry cannot silently grant
      // ComsNet; a future environment policy may omit it for receive-only or untrusted seats.
