...
export const ClientSettingsSchema = Schema.Struct({
  ...
  renderOperatorLinks: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
});
...
export const PiSettings = makeProviderSettingsSchema(
  {
    ...
    modelFloor: Schema.Record(Schema.String, Schema.String).pipe(
      Schema.withDecodingDefault(Effect.succeed({ openai: "gpt-5.4", anthropic: "claude-4.8" })),
      Schema.annotateKey({ providerSettingsForm: { hidden: true } }),
    ),
  },
  {
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  renderOperatorLinks: Schema.optionalKey(Schema.Boolean),
});
